...
!(function (u) {
      ...
      ne(window, 'message', function (t) {
        ...
        O === ('' + t.data).substr(0, S) &&
          (!1 === f
            ...
            : r()
            ? n.init()
            : re('Ignored message of type "' + o() + '". Received before initialization.'));
      }),
      ...
      !(function () {
        ...
        (function () {
          function e(e, t) {
            return (
              'function' == typeof e &&
                (re('Setup custom ' + t + 'CalcMethod'), (W[t] = e), (e = 'custom')),
              e
            );
          }
          ...
          autoResize: function (e) {
            return (
              !0 === e && !1 === n
                ...
                : !1 === e &&
                  !0 === n &&
                  ((n = !1), le('remove'), null !== t && t.disconnect(), clearInterval(b)),
        ...
        (y = (function () {
          function r(e) {
            var t = e.getBoundingClientRect(),
              n = {
                x:
                  window.pageXOffset !== u ? window.pageXOffset : document.documentElement.scrollLeft,
          ...
          function n(e) {
            ...
            u !== i
              ...
              : (re('In page link (#' + n + ') not found in iFrame, so sending to parent'),
                Ae(0, 0, 'inPageLink', '#' + n));
          }
          function e() {
    ...
    function le(e) {
      de({
        ...
        de({ method: e, eventType: 'Orientation Change', eventName: 'orientationchange' }),
        de({ method: e, eventType: 'Print', eventName: ['afterprint', 'beforeprint'] }),
        de({ method: e, eventType: 'Ready State Change', eventName: 'readystatechange' }),
        ...
        'child' === N && de({ method: e, eventType: 'IFrame Resized', eventName: 'resize' });
    }
    function fe(e, t, n, o) {
      return (
        t !== e &&
          (e in n || (ae(e + ' is not a valid option for ' + o + 'CalculationMethod.'), (e = t)),
              ...
              ? e
                ...
                : (t = (function () {
                    ...
                    return {
                      disconnect: function () {
                        'disconnect' in s &&
                          (re('Disconnect body MutationObserver'), s.disconnect(), u.forEach(o));
                      },
                    };
                  })())
